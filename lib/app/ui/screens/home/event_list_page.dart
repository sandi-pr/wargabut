...
class _EventListPageState extends State<EventListPage> {
  ...
  Future<void> _confirmLocationPermission() async {
    ...
    final result = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          "Fitur ini memerlukan akses lokasi Anda untuk mencari event terdekat dari posisi Anda saat ini. Data lokasi tidak disimpan.",
        ),
        actions: [
          TextButton(
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context, ThemeProvider themeProvider, EventProvider eventProvider) {
    return AppBar(
      titleSpacing: 0.0,
      ...
      title: Center(
        child: Container(
          ...
          child: SearchBar(
            ...
            onSubmitted: (value) => context.read<EventProvider>().setSearchTerm(value),
            ...
            trailing: <Widget>[
              if (eventProvider.searchTerm.isNotEmpty)
                IconButton(
                  ...
                  onPressed: () => context.read<EventProvider>().clearFilters(),
                )
              else
                Tooltip(
                  message: 'Ubah tema',
    ...
    return SpeedDial(
      ...
      children: [
        SpeedDialChild(
          ...
          label: 'Refresh Event',
          onTap: () => context.read<EventProvider>().fetchData(forceRefresh: true),
        ),
        SpeedDialChild(
          child: const Icon(Icons.location_on),
          label: 'Geocode Event (Once)',
          onTap: () async {
            final provider = context.read<EventProvider>();

            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('⏳ Memulai geocoding event...'),
              ),
            );
        ...
        SpeedDialChild(
          ...
          label: 'Add Event',
          onTap: () => context.push('/jeventku/baru'),
        ),
      ],
    );
  }

  Widget _buildFilterControls(BuildContext context, EventProvider eventProvider) {
    ...
    return Padding(
      ...
      child: SegmentedButton<String>(
        ...
        selected: <String>{
          if (context.read<EventProvider>().selectedAreas.isNotEmpty) 'Lokasi',
  ...
  Widget _buildFilteredResults(BuildContext context, EventProvider eventProvider, bool isDesktop) {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const Text('Event Tidak Ditemukan', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: 8),
                              Text(
                                  'Cari event anime, manga, atau budaya Jejepangan di sekitarmu!',
          ...
          Center(
            child: ElevatedButton(
              onPressed: () {
                ...
                context.read<EventProvider>().showFullList();
              },
              child: const Text("Lihat Semua Event"),
            ),
          ),
        ],
      ),
        ...
        children: [
          ...
          if (!eventProvider.hasUserLocation)
            Center(
              child: ElevatedButton.icon(
                ...
                label: const Text("Cari Event Terdekat"),
          ...
          /// 2️⃣ SUDAH ADA LOKASI TAPI BELUM ADA EVENT
            ...
            const Padding(
              ...
              child: Text("Tidak ada event dalam radius terdekat."),
            )
          ...
          /// 3️⃣ TAMPILKAN EVENT
              ...
              /// 4️⃣ TOMBOL LIHAT SEMUA
                Center(
                  child: ElevatedButton(
                    onPressed: () =>
                        context.read<EventProvider>().showAllNearest(),
