...
class _EventListPageState extends State<EventListPage> {
  ...
  final config = ListPageConfig.event;
  ...
  void _loadMonths(List<DateTime> sourceDates) {
    ...
    context.read<EventProvider>().setSelectedMonths(temp);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveListScaffold(
      ...
      onSearchSubmitted: (val) => context.read<EventProvider>().setSearchTerm(val),
      onClearSearch: () => context.read<EventProvider>().clearFilters(),

      // MENGGUNAKAN SHARED COMPONENT FAB
      floatingActionButton: SharedAdminFab(
        isAdmin: authProvider.isAdmin,
        onRefresh: () => context.read<EventProvider>().fetchData(forceRefresh: true),
